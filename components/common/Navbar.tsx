  ...
  const navigation = [
    {
      name: "WOMEN",
      href: "/women",
      current: path === "/women" ? true : false,
    },
    { name: "MEN", href: "/men", current: path === "/men" ? true : false },
    { name: "KIDS", href: "/kids", current: path === "/kids" ? true : false },
    {
      name: "COLLECTION",
      href: "/collection",
      current: path === "/collection" ? true : false,
    },
  ];
  ...
  const authNavigation = [
    {
      name: "LOGIN",
      href: "/sign-in",
      current: path === "/sign-in" ? true : false,
      onclick: () => signIn(),
    },
    {
      name: "REGISTER",
      href: "/sign-up",
      current: path === "/sign-up" ? true : false,
      onclick: () => {},
    },
  ];
        ...
        <>
          <div className="fixed z-50 backdrop-blur-xl top-0 -left-1 min-[1350px]:left-auto w-full sm:max-w-7xl flex h-16 items-center justify-between">
            <div className="absolute inset-y-0 left-0 flex items-center lg:hidden">
              {/* Mobile menu button*/}
              <Disclosure.Button
                className="relative z-50 inline-flex items-center justify-center rounded-md p-2 m-2
          ...
          <Disclosure.Panel className="lg:hidden mt-16">
